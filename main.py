...
def main():
    # Load an image for depth estimation and object detection
    IMAGE_PATH = "D:/FYP/custom model/main prog/test_image (1).jpeg"
    if IMAGE_PATH is None:
        print(f"Failed to load image: {IMAGE_PATH}")
        exit()

    MODEL_PATH = "D:/FYP/custom model/model training/runs/obb/train/weights/best.pt"
